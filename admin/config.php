<?php
// HTTP
define('HTTP_SERVER', 'https://www.headstractor.com.au/admin/');
define('HTTP_CATALOG', 'https://www.headstractor.com.au/');

// HTTPS
define('HTTPS_SERVER', 'https://www.headstractor.com.au/admin/');
define('HTTPS_CATALOG', 'https://www.headstractor.com.au/');

// DIR
define('DIR_APPLICATION', '/home/onlineorders/public_html/admin/');
...
define('DIR_CATALOG', '/home/onlineorders/public_html/catalog/');
...
define('DB_CONNECTION_TIMEOUT', 5);  // Reduce from 20 to 5 seconds
