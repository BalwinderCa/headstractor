<?php
class ControllerExtensionModulechildcatprodtoparcat extends Controller { 	
	private $error = array();
	private $modpath = 'module/childcatprodtoparcat'; 
	private $modtpl = 'module/childcatprodtoparcat.tpl';
	private $modname = 'childcatprodtoparcat';
	private $modtext = 'Display All Child Categories Products On Parent Category';
	private $modid = '36616';
	private $modssl = 'SSL';
	...
	public function __construct($registry) {
		...
		if(substr(VERSION,0,3)>='3.0' || substr(VERSION,0,3)=='2.3') { 
			$this->modtpl = 'extension/module/childcatprodtoparcat';
			$this->modpath = 'extension/module/childcatprodtoparcat';
		} else if(substr(VERSION,0,3)=='2.2') {
			$this->modtpl = 'module/childcatprodtoparcat';
		} 
		
		if(substr(VERSION,0,3)>='3.0') { 
			$this->modname = 'module_childcatprodtoparcat';
