...
class __TwigTemplate_9d5c80dd0fed50784e815b28f9837488 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Exporting a raw query");
  ...
  ";
    ...
    {
        return new Source("", "table/export/index.twig", "/home/onlineorders/public_html/phpmyadmin/templates/table/export/index.twig");
    }
}
