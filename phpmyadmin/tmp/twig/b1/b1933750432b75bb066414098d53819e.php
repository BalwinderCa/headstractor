...
class __TwigTemplate_8d2c83afc57839c6f76290d7ec0a98e7 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/home/onlineorders/public_html/phpmyadmin/templates/preferences/header.twig");
    }
}
