...
class __TwigTemplate_b2296479182e63db71374165300057ba extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/home/onlineorders/public_html/phpmyadmin/templates/database/export/index.twig");
    }
}
